...
(function () {
  ...
  const MANIFEST = [
    ...
    { file: "chapter-17.html", title: "ตอนที่ 17: น้ำแข็งกับเงา", subtitle: "แสงสีม่วงจากแกนมอนสเตอร์ไหลลงสู่พื้นหินเหมือนหยดหมึกที่มีชีวิต" },
    { file: "chapter-18.html", title: "ตอนที่ 18: บอสที่ไม่ควรอยู่ที่นี่", subtitle: "ประตูหินขนาดมหึมาเลื่อนเปิดช้า ๆ พร้อมเสียงครูดลึกที่สะเทือนไปทั้งห้อง" }
  ];
