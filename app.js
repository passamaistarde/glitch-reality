...
(function () {
  ...
  const MANIFEST = [
    ...
    { file: "chapter-20.html", title: "ตอนที่ 20: กำแพงของกฎเกณฑ์", subtitle: "โถงต้อนรับของสำนักงานใหญ่ JLA ชินจูกุ ยังคงเย็นสบายและเงียบส..." },
    { file: "chapter-21.html", title: "ตอนที่ 21: บทเพลงของยมทูต", subtitle: "ทุ่งหินสีเลือดกลายเป็นสนามสังหาร" }
  ];
