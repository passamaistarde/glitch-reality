...
(function () {
  ...
  const MANIFEST = [
    ...
    { file: "chapter-11.html", title: "ตอนที่ 11: เงาที่ไม่ได้เรียก", subtitle: "สนามต่อสู้อย่างเป็นทางการของ JLA อยู่ชั้นใต้ดิน B5" },
    { file: "chapter-12.html", title: "ตอนที่ 12: ก้าวเงา", subtitle: "เช้าวันถัดมา — วันที่ 34 นับจากวันที่ระบบตื่น" }
  ];
